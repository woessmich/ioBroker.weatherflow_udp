...
The additional parameters freq, hw_version and hardware_id are not listed there.
They seem to have been introduced in Tempest '26 hardware refresh.
*/

const { ENETDOWN } = require("node:constants");
    ...
    5: [
      "lightningStrikeAvgDistance",
      {
        ...
        common: {
          ...
          write: false,
          role: "value.distance",
          name: "Lightning Strike Avg Distance",
        },
        native: {},
      },
    ],
    ...
    3: [
      "rainAccumulated",
      {
        ...
        common: {
          ...
          read: true,
          write: false,
          role: "value.precipitation.interval",
          name: "Rain Accumulated",
        },
        native: {},
      },
    ],
    4: [
      "windLull",
      {
        ...
        common: {
          ...
          read: true,
          write: false,
          role: "value.speed.wind.lull",
          name: "Wind Lull (minimum 3 second sample)",
        },
        native: {},
      },
    ],
    5: [
      "windAvg",
      {
        ...
        common: {
          ...
          write: false,
          role: "value.speed.wind",
          name: "Wind Avg (average over report interval)",
        },
        native: {},
      },
    ],
    6: [
      "windGust",
      {
        ...
        common: {
          ...
          name: "Wind Gust (maximum 3 second sample)",
        },
        native: {},
      },
    ],
    ...
    11: [
      "localDayRainAccumulation",
      {
        ...
        common: {
          ...
          read: true,
          write: false,
          role: "value.precipitation.day",
          name: "Local Day Rain Accumulation",
        },
        native: {},
      },
    ],
    ...
    14: [
      "lightningStrikeAvgDistance",
      {
        ...
        common: {
          ...
          write: false,
          role: "value.distance",
          name: "Lightning Strike Average Distance",
        },
        native: {},
      },
    ],
  ...
  reset_flags: {
    0: [
      "reset_flags",
      {
        ...
        native:
          {} /* BOR	Brownout reset, PIN	PIN reset, POR	Power reset, SFT	Software reset, WDG	Watchdog reset, WWD	Window watchdog reset, LPW	Low-power reset */,
      },
    ],
  },
  seq: {
    ...
    2: [
      "radio_stats.I2CBusErrorCount",
      {
        ...
        common: {
          ...
          write: false,
          role: "value",
          name: "I2C Bus Error Count",
        },
        native: {},
      },
    ],
    3: [
      "radio_stats.radioStatus",
      {
        type: "state",
        common: {
          type: "mixed",
